    ...
    <div class="col-lg-8">
        <div class="card">
                ...
                <form action="{{route('agregarTipoCurso')}}" method="post" class="">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-6">
                            <label for="tipo" class=" form-control-label">Tipo de Curso</label>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col col-md-6">
                            <a href="{{route('listaTipoCurso',$uri)}}" class="btn btn-danger btn-block">
            ...
            <div class="card-footer">
                El Tipo de Curso Registrado es automaticamente Activada para la seleccion del mismo.
            </div>
        </div>
    </div>
    <div class="col-lg-2">
