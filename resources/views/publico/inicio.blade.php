...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('publico/assets/vendor/perfect-scrollbar/css/perfect-scrollbar.css')}}">
...
<body class="theme-red">
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="{{asset('publico/assets/img/person.jpg')}}" alt="">
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="gridder my-3">
        <div class="grid-item apps wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-1.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Mobile Travel App</h5> <p>Travel, Discovery</p>">
            <img src="{{asset('publico/assets/img/work/work-1.jpg')}}" alt="">
        ...
        <div class="grid-item template wireframes wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-2.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Music App</h5> <p>Musics</p>">
            <img src="{{asset('publico/assets/img/work/work-2.jpg')}}" alt="">
            <div class="img-caption">
        ...
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-3.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Gaming Dashboard</h5> <p>Games, Streaming</p>">
            <img src="{{asset('publico/assets/img/work/work-3.jpg')}}" alt="">
            <div class="img-caption">
        ...
        <div class="grid-item graphic ui-ux wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-4.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Drugs Delivery App</h5> <p>Health, Drugs</p>">
            <img src="{{asset('publico/assets/img/work/work-4.jpg')}}" alt="">
            <div class="img-caption">
        ...
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-5.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Musics Discover</h5> <p>Musics, Dashboard</p>">
            <img src="{{asset('publico/assets/img/work/work-5.jpg')}}" alt="">
            <div class="img-caption">
        ...
        <div class="grid-item graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="{{asset('publico/assets/img/work/work-6.jpg')}}" data-fancybox data-caption="<h5 class='fg-theme'>Game Streaming</h5> <p>Games, Streaming</p>">
            <img src="{{asset('publico/assets/img/work/work-6.jpg')}}" alt="">
            <div class="img-caption">
          ...
          <div class="owl-carousel testi-carousel">
            <div class="item">
              <div class="row">
                <div class="col-md-6">
                  <div class="img-place">
                    <img src="{{asset('publico/assets/img/testimonials/testimonials_1.jpg')}}" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="caption">
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6">
                  <div class="img-place">
                    <img src="{{asset('publico/assets/img/testimonials/testimonials_2.jpg')}}" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="caption">
    ...
    <div class="container">
      ...
      <div class="row post-grid">
        <div class="col-md-6 col-lg-4 wow fadeInUp">
          <div class="card">
            <div class="img-place">
              <img src="{{asset('publico/assets/img/work/work-9.jpg')}}" alt="">
            </div>
            <div class="caption">
  ...
  <script src="{{asset('publico/assets/vendor/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
  ...
  <script src="{{asset('publico/assets/js/google-maps.js')}}"></script>
